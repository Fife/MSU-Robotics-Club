ex=h5read('A.out','/rxs/rx1/Ex');
ey=h5read('A.out','/rxs/rx1/Ey');
ez=h5read('A.out','/rxs/rx1/Ez');
hx=h5read('A.out','/rxs/rx1/Hx');
hy=h5read('A.out','/rxs/rx1/Hy');
hz=h5read('A.out','/rxs/rx1/Hz');
